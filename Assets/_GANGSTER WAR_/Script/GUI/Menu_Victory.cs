    ...
    IEnumerator Start()
    {
        ...
        foreach (var fortrest in theFortress)
        {
            ...
            if ((fortrest.currentHealth / fortrest.maxHealth) > 0)
            {
                ...
                GameManager.Instance.levelStarGot = Mathf.Max(1, GlobalValue.LevelStar(GlobalValue.levelPlaying));
            }
            ...
            if ((fortrest.currentHealth / fortrest.maxHealth) > 0.5f)
            {
                ...
                GameManager.Instance.levelStarGot = Mathf.Max(2, GlobalValue.LevelStar(GlobalValue.levelPlaying));
            }
            ...
            if ((fortrest.currentHealth / fortrest.maxHealth) > 0.8f)
            {
                ...
                GameManager.Instance.levelStarGot = Mathf.Max(3, GlobalValue.LevelStar(GlobalValue.levelPlaying));
            }
            //}
        }
