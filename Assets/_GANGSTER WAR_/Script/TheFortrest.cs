...
public class TheFortrest : MonoBehaviour, ICanTakeDamage
{
    ...
    void Awake()
    {
        ...
        //{
            maxHealth = fortrestLevels[Mathf.Min(fortrestLevels.Length - 1, upgradeWallParameter.CurrentUpgrade)].maxHealth;
            stateFortrestSprites = fortrestLevels[upgradeWallParameter.CurrentUpgrade].stateFortrestSprites;
    ...
    void Start()
    {
        ...
        maxHealth = upgradeWallParameter.UpgradeWallHealth;
